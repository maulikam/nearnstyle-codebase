...
INSERT INTO public.hc_role_master (id, "name", state, created_by, created_on, modified_by, modified_on)
...
INSERT INTO public.hc_role_master (id, "name", state, created_by, created_on, modified_by, modified_on)
VALUES(4,'DOCTOR', 'ACTIVE', -1, '2022-11-23 22:48:08.500', NULL, NULL);

INSERT INTO public.hc_role_master (id, "name", state, created_by, created_on, modified_by, modified_on)
VALUES(5,'PATIENT', 'ACTIVE', -1, '2022-11-23 22:48:08.500', NULL, NULL);


INSERT INTO hc_salon (name, code, address, ad_state, ad_district, ad_city, ad_pincode, state,  latitude, longitude, created_by, created_on, modified_by, modified_on)
...
INSERT INTO hc_user (user_name, role_id, mobile_number, date_of_birth, email_id, first_name, middle_name, last_name, gender, password, address, state, org_id, no_of_attempts, created_by, created_on, modified_by, modified_on)
VALUES ('mdave',
        (SELECT id FROM hc_role_master WHERE name = 'SUPER ADMIN'),
        ...
        (SELECT id FROM hc_salon WHERE name = 'Argusoft'),
        0, 1, NOW(), 1, NOW());
